...
import com.loyalty.testing.s3.routes.s3.`object`.{CompleteUploadRoute, DeleteObjectRoute, GetObjectRoute, InitiateMultipartUploadRoute, PutObjectRoute, UploadPartRoute}
